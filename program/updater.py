...
async def update_repo(_, message: Message):
    ...
    msg = await message.reply("يتم التحديث الان.`")
    ...
    if update_avail:
        ...
        return
    await msg.edit(f"bot is **up-to-date** with [main](https://github.com/rusyaf3/sezzr/tree/main)", disable_web_page_preview=True)
